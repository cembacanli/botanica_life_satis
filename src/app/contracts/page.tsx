            ...
            {!selectedContract ? (
              ...
              <>
                <section className="rounded-[1.75rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
                  ...
                  {selectedContract.subcontractor.contractFileUrl ? (
                    <div className="mt-6">
                      <a
                        href={selectedContract.subcontractor.contractFileUrl}
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center justify-center gap-2 rounded-2xl bg-emerald-700 hover:bg-emerald-800 text-white px-4 py-3 text-sm font-semibold transition"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
                        </svg>
                        Sözleşme Belgesini Görüntüle ({selectedContract.subcontractor.contractFileName || 'Dosya'})
                      </a>
                    </div>
                  ) : null}
