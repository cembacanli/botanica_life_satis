...
export default function CeramicCalculatorPage() {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-stone-600">Alt modül: Seramik Metraj Programı</p>
          </div>
        ...
        <CeramicCalculator username={user?.username || ''} />
      </div>
    </div>
  )
}
